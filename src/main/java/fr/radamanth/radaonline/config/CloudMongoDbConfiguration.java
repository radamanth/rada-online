...
import fr.radamanth.radaonline.config.oauth2.OAuth2AuthenticationReadConverter;
import fr.radamanth.radaonline.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("fr.radamanth.radaonline.repository")
